...
Description: Encourages a more professional workflow. A draft is written. Then reviewed (if only by you, the author). Then published to the community (restricted access). Then reviewed again and publicly published. (It sets post to private as default.)
Version: 2018.06.01
Author: wp.cbos.ca
