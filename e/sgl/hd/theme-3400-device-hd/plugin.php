<?php
/*
Plugin Name:    Theme: 3400-Device-HD
Plugin URI:     https://wp.cbos.ca/themes/the-hd-theme/
Description:    HD Theme.
Version:        2015.12.15
License:        GPLv2+
*/ 
...
function enqueue_theme_hd() {
	wp_enqueue_style( 'theme-hd', plugin_dir_url(__FILE__) . 'css/style.css', array(), time() );
}
add_action( 'wp_enqueue_scripts', 'enqueue_theme_hd', 45 );
