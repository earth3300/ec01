 ...
 * EC01 JSON Reader
 *
 * Reads an JSON file in the directory in which it is placed and displays it as
 ...
 * @link https://github.com/earth3300/ec01-json-reader
 *
 * @wordpress-plugin
 * Plugin Name: EC01 JSON Reader
 * Plugin URI:  https://github.com/earth3300/ec01-json-reader
 * Description: Reads and JSON file and displays it in HTML.  Shortcode [json-reader dir=""].
 * Version: 0.0.1
 * Author: Clarence J. Bos
 * Author URI: https://github.com/earth3300/
 * Text Domain: ec01-json-reader
 * License:  GPL v3.0
...
/**
* Reads an JSON file and displays it in HTML.
 *
...
class JSONReader
{
    ...
    'css' => '/0/theme/css/style.css',
		'url' => 'https://github.com/earth3300/ec01-json-reader',
		'msg' => [
			'success' => 'Success',
	...
	/**
	 * Gets JSON File and Return as HTML
	 *
	 * Allow only JSON. Possibly use the MIME type.
	 *
 ...
 * @var [type]
 */
class JSONData extends JSONReader
{
...
/**
 * Callback from the json-reader Shortcode
 *
 * Performs a check, then instantiates the JSONReader class
...
function media_index( $args )
{
	if ( is_array( $args ) )
	{
		...
		return $json_reader->get( $args );
	}
	else
	{
		return '<!-- Missing the image directory to process. [json-reader dir=""]-->';
	}
}
...
if( function_exists( 'add_shortcode' ) )
{
	...
	/** Add shortcode [json-reader dir=""] */
	add_shortcode( 'json-reader', 'json_reader' );
}
/**
