...
function get_html5_header( $post = '' ){
	if ( 1 && file_exists( dirname(__FILE__) .  '/html/header.html' ) ) {
...
function get_html5_footer_copyright( $post = '' ){
	if ( 1 && is_active_sidebar( 'footer-copyright' ) ) {
		ob_start();
...
function get_html5_footer_menu( $post = '' ){
	if ( 1 && is_active_sidebar( 'footer-menu' ) ) {
...
function get_html5_footer_credits( $post = '' ){
	if ( 1 && is_active_sidebar( 'footer-credits' ) ) {
		ob_start();
...
function get_html5_footer_social( $post = '' ){
	if ( 1 && is_active_sidebar( 'footer-social' ) ) {
		ob_start();
