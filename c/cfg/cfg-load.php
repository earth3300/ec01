...
if ( file_exists( __DIR__ . '/site/wp' . '/cfg-debug.php' ) ) {
  /** Optional */
  require_once( __DIR__ . '/site/wp' . '/cfg-debug.php' );
}

if ( file_exists( __DIR__ . '/site/wp' . '/cfg-wordpress.php' ) ) {
  /** Required if WordPress used */
  require_once( __DIR__ . '/site/wp' . '/cfg-wordpress.php' );
}

if ( file_exists( __DIR__ . '/site/wp' . '/cfg-plugins.php' ) ) {
  /** Important if WordPress used */
  require_once( __DIR__ . '/site/wp' . '/cfg-plugins.php' );
}
